(function () {
    ...
    function blogType($scope,$http,$window,toastr,common) {
		...
		var getAllDatas = function(){
			$http({
		        method: 'GET',
		        url: $scope.basePath+"/back/type/getType/"+$scope.pagination.pageSize
		...
		$scope.pre = function(){
			...
			$http({
		        method: 'GET',
		        url: $scope.basePath+"/back/type/getType/"+($scope.pagination.pageSize-1)
		    }).then(function successCallback(response) {
		...
		$scope.delDatas = function(){
			var url = $scope.basePath+"/back/type/delType/"+$scope.formData.typeid;
			$http.get(url)
		...
		$scope.saveDatas = function(){
			...
			var url = $scope.basePath+"/back/type/saveType";
